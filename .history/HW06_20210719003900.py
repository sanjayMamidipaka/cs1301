...
noodlesDict = {'cold': 'soba', 'hot': ['spaghetti', 'ramen']}
print('soba' in noodlesDict)

num = 0    for x in range(len(tupList)):        if x%2==0:            num += 1            tupList[x] = num    return tupListresult = func([(8,6,7,5),(3,0,9)])
