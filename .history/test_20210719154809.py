...
def festival(artistList): 
    ...
    for artist in artistList: try: if songRating[artistList[artist]] > 7: goodArtists.append(artist) else: print("not good enough") except: print("not one of your artists") continue 
return goodArtists 
