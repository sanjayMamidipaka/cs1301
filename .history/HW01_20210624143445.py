...
def bake(cakes, cupcakes, cookies):
    ...
    hours = total_time//60 #converts the total minutes into hours
    minutes = total_time % 60 #converts the 

    print('It will take {} hours and {} minutes to make {} cakes, {} cupcakes, and {} cookies.'.format(hours, minutes, cakes, cupcakes, cookies))
