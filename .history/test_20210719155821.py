...
def concerts(): ratings = {5.0: ["The Shins"], 4.5: venues = [(5.0, "infinite energy"), for r, c in venues: it r in ratings: ["The", "Beatles"]). (2, "the loft")] 
print("Add {} to {}".format(c, r)) ratings[r].append(c) else: print("Add {} to ratings".format(r)) 
print(concerts()) 
