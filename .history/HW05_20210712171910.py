...
festivals = {"Music Midtown": ["Maroon 5", "MileyCyrus", "21 Savage","DaBaby", "Megan Thee Stallion", "Lauv","Machine Gun Kelly", "Jonas Brothers"],"Shaky Knees": ["The Strokes", "Mac Demarco","The Backseat Lovers", "Dominic Fike","St. Vincent"],"Lollapalooza": ["Dominic Fike", "Dayglow", "Lauv","Boy Pablo","The Backseat Lovers","Mt.Joy", "Young the Giant"]}>> artistList = ["Declan Mckenna", "Peach Pit", "GlassAnimals", "The BackseatLovers", "COIN", "Dominic Fike"]>>> musicFestival(festivals, artistList, 2)