...
count = 0 myString = "h!fun8FunFungfunFunOFUnp" newString = "" 
for char in range(22): continue if phrase[char:char+3] == "fun": count += 1 elif phrase[char:char+3] == "Fun": count += 1 else: newPhrase += phrase[char:char+3] 
print(count) 
