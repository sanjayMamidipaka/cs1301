...
def bookstore(daysBorrowed):
    daysBorrowedWithFines = daysBorrowed-14
    fines = daysBorrowedWithFines * 0.25
    print('Your total amount due is ${}'.format(fines))
...
def monthlyAllowance(allowance, savingsPercentage):
    amountLeftOver = allowance * (100-savingsPercentage)
