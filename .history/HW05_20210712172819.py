...
festivals = {"Music Midtown": ["Maroon 5", "MileyCyrus", "21 Savage","DaBaby", "Megan Thee Stallion", "Lauv","Machine Gun Kelly", "Jonas Brothers"],"Governors Ball": ["Billie Eilish","Post Malone","Megan Thee Stallion", "A$AP Rocky","21 Savage", "Young Thug"],"Firefly": ["Tame Impala", "MachineGun Kelly", "Diplo","Megan Thee Stallion", "Wiz Khalifa","Dominic  Fike", "Lizzo", "Blackbear"]}>> artistList = ["Megan Thee Stallion", "Drake", "MachineGun Kelly", "21Savage", "Justin Beiber", "Billie Eilish", "Post Malone"]>>> musicFestival(festivals, artistList, 3)