...
categoryList = ["Italian","American", "Mediterranean"] >>> restaurantList = [ ("Olive Garden", 3.2, "Italian"), ("Taco Mac", 4.3, "TexMex"), ("Chili’s", 5.0, "American")] >>> restaurantRatings(categoryList, restaurantList) 