...
def snackTime(taList):
    ...
    for ta in taList:
        if ta[2] >= 11 and ta[2] <= 14 or ta[2] >= 21 and ta[2] <= 23:
            ...
            taOptimalSnacksList[index].append(ta[1])
...
taList = [ ("Emily", "pretzels", 12), ("Michael", "celery", 4), ("Elizabeth", "hot cheetos", 1),("Emily", "fruit", 23), ("Corinne", "cookies", 9), ("Emily", "skittles", 22)] >>> snackTime(taList) 
