...
def waterGames(gameName, numPlayers, totalFriends):
    percentPlaying = (numPlayers/totalFriends) * 100

    if percentPlaying < 30:
        print('Let’s choose something else.')
    elif percentPlaying >= 30 and percentPlaying < 75:
        print('We will',gameName,'for a little bit!')
    elif percentPlaying >= 75:
